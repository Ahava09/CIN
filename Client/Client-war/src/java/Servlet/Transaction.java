...
import Bank.TransactionLocal;
import devises.CoursDevise;
import devises.CoursDeviseLocal;
import devises.Devise;
import devises.DeviseLocal;
...
public class Transaction extends HttpServlet {
    @EJB
    CoursDeviseLocal coursdeviselocal;
    @EJB
...
//        String num_cin = (String) request.getSession().getAttribute("num_cin");
        ...
        try {
            Vector<Devise> devises = deviselocal.getAll();
            request.setAttribute("devises", devises);
            Vector<Bank.Transaction> transaction = transactionlocal.getAll(); 
            request.setAttribute("transactions", transaction);
            RequestDispatcher dispat = request.getRequestDispatcher("/operation.jsp");
